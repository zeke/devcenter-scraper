...
Heroku automatically provisions a [small database](heroku-postgres-starter-tier) when you create a Java application and sets the `DATABASE_URL` environment variable to a URL of the format
