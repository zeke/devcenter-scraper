...
Node [best practice](http://www.futurealoof.com/posts/nodemodules-in-git.html) is to include the `node_modules` directory in your source repository for faster deploys and [dev/prod parity](http://www.12factor.net/dev-prod-parity).
</div>
...
Use the module to connect to  using the provisioned MongoDB URL located in the environment.
