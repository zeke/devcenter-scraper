...
[Heroku only stores the last 1500 lines of log history](limits#log-history-limits).  If you'd like to persist more than 1500 lines, use a [logging add-on](https://addons.heroku.com/#logging) or create your own [syslog drain](#syslog-drains).
